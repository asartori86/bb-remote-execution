...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:b5CCDFx12sCCz76gne19RoGBX+1KF+rSpHf6a4ji6vI=",
        version = "v1.27.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MUot0cyxRrl/dmLFNymQ4O69BAvKBFPJpPStdHqXdt8=",
        version = "v1.20.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:9uuv//cjVvfJBuoMcNw265YkcVw03ERWzxcw8Xv9nxE=",
        version = "v0.0.0-20230317062200-2cbf9f602b09",
    )
    go_repository(
